<template>
  <div>
    ...
    <main class="container">
      <section class="mainVisual">
        <div class="mainImgWrapper">
          <div class="mainImg">
            ...
            <img src="../assets/img/miwa-profile.jpg" alt="Miwa Tanaka" loading="lazy" width="605" height="807">
          </div>
        </div>
      </section>
      ...
      <div class="custom-shape-divider-bottom-1658011892">
    ...
    <footer>
      <p>&copy; Copyright 2022, Miwa Tanaka</p>
    </footer>
  </div>
</template>
